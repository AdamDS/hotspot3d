...
sub new {
	my $class = shift;
	my $this = {};
	$this->{'prep_dir'} = undef;#"hotspot3d/t/Preprocessing_Output";
	$this->{'pairwise'} = undef;#"hotspot3d/t/PairwiseTest/chosen.cancer.monomer.ALK.4CCB.[A].pairwise";
	$this->{'clusters'} = undef;#" hotspot3d/t/ClustersTest/chosen.cancer.monomer.TP53.4IBY.[A].single_molecule_pvalue.intra.0..05.10.clusters";
	$this->{'output'} = "hotspot3d.cluster.significance.tsv"; #"test1";
